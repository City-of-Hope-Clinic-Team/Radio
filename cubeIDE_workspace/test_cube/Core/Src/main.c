...
int main(void)
{
  ...
  */
  ...
  readData = NRF24_read_register(REG_RX_ADDR_P5);
  NRF24_write_register(REG_RX_ADDR_P5, 0xDE);
  readData = NRF24_read_register(REG_CONFIG);
  NRF24_write_register(REG_RX_ADDR_P5, 0xAD);
  readData = NRF24_read_register(REG_RX_ADDR_P5);
